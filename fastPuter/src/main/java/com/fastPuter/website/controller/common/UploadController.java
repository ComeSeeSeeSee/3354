...
import com.fastPuter.website.util.FastPuterUtils;
...
public class UploadController {
    ...
    public Result upload(HttpServletRequest httpServletRequest, @RequestParam("file") MultipartFile file) throws URISyntaxException {
        ...
        try {
            ...
            resultSuccess.setData(FastPuterUtils.getHost(new URI(httpServletRequest.getRequestURL() + "")) + "/upload/" + newFileName);
    ...
    public Result uploadV2(HttpServletRequest httpServletRequest) throws URISyntaxException {
        ...
        if (standardServletMultipartResolver.isMultipart(httpServletRequest)) {
            ...
            while (iter.hasNext()) {
                if (total > 5) {
                    return ResultGenerator.genFailResult("Upload up to 5 pictures");
                }
                total += 1;
        ...
        for (int i = 0; i < multipartFiles.size(); i++) {
            ...
            try {
                ...
                fileNames.add(FastPuterUtils.getHost(new URI(httpServletRequest.getRequestURL() + "")) + "/upload/" + newFileName);
            } catch (IOException e) {
                e.printStackTrace();
                return ResultGenerator.genFailResult("File upload failed");
            }
